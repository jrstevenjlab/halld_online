...
void tdc1190PrintGeoAddress(int id);
int  tdc1190Slot(int id);
int  tdc1190Id(int slot);
int  tdc1190GetBoardID(int id);
int  tdc1190GetBoardRev(int id);
int  tdc1190GetSerialNumber(int id);
...
void tdc1190PrintDMAdataType(int dataType);
void tdc1190PrintDMABerrFifo(int method);
/*S.P.end*/

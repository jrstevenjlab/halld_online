...
UINT32 dsc2GetBoardID(int id, int pflag);
...
int  dsc2SetBipolarThreshold(UINT32 id, UINT16 chan, INT16 val, UINT16 type);
int  dsc2GetBipolarThreshold(UINT32 id, UINT16 chan, UINT16 type);
int  dsc2SetBipolarThresholdAll(INT16 tdcVal, INT16 trgVal);

void  dsc2PrintTDCThresholds(UINT32 id);
void  dsc2PrintTDCThresholdsAll();

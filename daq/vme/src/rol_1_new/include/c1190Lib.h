...
#define V1190_VERS_A     0x00
#define V1190_VERS_N     0x02
...
STATUS tdc1190GStatus(int mcFlag);

int    tdc1190ReadMicro(int id, UINT16 *data, int nwords);
STATUS tdc1190GReadMicro(UINT16 *data, int nwords_per_module);
STATUS tdc1190WriteMicro(int id, UINT16 data);
...
int    tdc1190GEventFifo(UINT32 flag);
int    tdc1190ResetMCST(int id);
int    tdc1190BusError(int id, UINT32 flag);
int    tdc1190GBusError(UINT32 flag);
int    tdc1190Align64(int id, UINT32 flag);
int    tdc1190GAlign64(UINT32 flag);

int    tdc1190ConfigureGReadout(int choice);
...
STATUS tdc1190GSetTriggerMatchingMode();
STATUS tdc1190SetContinuousStorageMode(int id);
STATUS tdc1190GSetContinuousStorageMode();
...
STATUS tdc1190GSetWindowWidth(UINT32 window_width);
STATUS tdc1190SetWindowOffset(int id, INT32 window_offset);
STATUS tdc1190GSetWindowOffset(INT32 window_offset);
STATUS tdc1190SetExtraSearchMargin(int id, UINT32 window_extra);
STATUS tdc1190GSetExtraSearchMargin(UINT32 window_extra);
STATUS tdc1190SetRejectMargin(int id, UINT32 window_reject);
STATUS tdc1190GSetRejectMargin(UINT32 window_reject);
STATUS tdc1190EnableTriggerTimeSubtraction(int id);
STATUS tdc1190GEnableTriggerTimeSubtraction();
STATUS tdc1190DisableTriggerTimeSubtraction(int id);
STATUS tdc1190GDisableTriggerTimeSubtraction();
...
STATUS tdc1190GSetEdgeDetectionConfig(UINT16 setedge);
...
STATUS tdc1190GSetEdgeResolution(UINT16 edge_res);
...
STATUS tdc1190GSetPairResolution(UINT32 leading_res, UINT32 pulse_width_res);
STATUS tdc1190GetPairResolution(int id, UINT32 *leading_res, UINT32 *pulse_width_res);
STATUS tdc1190GGetPairResolution(UINT16 *pair_res);
STATUS tdc1190SetDoubleHitResolution(int id, UINT16 double_hit_res);
STATUS tdc1190GSetDoubleHitResolution(UINT16 doublehit_res);
...
STATUS tdc1190GEnableTDCHeaderAndTrailer();
STATUS tdc1190DisableTDCHeaderAndTrailer(int id);
STATUS tdc1190GDisableTDCHeaderAndTrailer();
...
STATUS tdc1190GSetMaxNumberOfHitsPerEvent(UINT32 nhits);
...
STATUS tdc1190GEnableTDCErrorMark();
STATUS tdc1190DisableTDCErrorMark(int id);
STATUS tdc1190GDisableTDCErrorMark();
STATUS tdc1190EnableTDCErrorBypass(int id);
STATUS tdc1190GEnableTDCErrorBypass();
STATUS tdc1190DisableTDCErrorBypass(int id);
STATUS tdc1190GDisableTDCErrorBypass();
STATUS tdc1190SetTDCErrorType(int id, UINT32 mask);
STATUS tdc1190GSetTDCErrorType(UINT32 mask);
...
STATUS tdc1190GSetEffectiveSizeOfReadoutFIFO(UINT32 nwords);
...
STATUS tdc1190GEnableAllChannels();
STATUS tdc1190DisableAllChannels(int id);
STATUS tdc1190GDisableAllChannels();
STATUS tdc1190EnableChannels(int id, UINT32 channel_mask);
STATUS tdc1190GEnableChannels(UINT32 channel_mask);
...
STATUS tdc1190GSetBLTEventNumber(UINT16 nevents);
int    tdc1190GetBLTEventNumber(int id);

STATUS tdc1190SetRCadjust(int id, int tdc, int adjust);
STATUS tdc1190GSetRCadjust(int tdc, int adjust);
